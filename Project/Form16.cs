    ...
    public partial class Form16 : Form
    {
        ...
        void print()
        {
            ...
            try
            {
                ...
                // Define the SQL query to retrieve customer support data along with patient data
                string sqlQuery = "SELECT CS.ISSUE_ID, CS.DESCRIPTION, CS.RESOLUTION, CS.TIMESTAMP, CS.PATIENT_ID, CS.STAFF_ID, " +
                                  "P.MEDICAL_HISTORY, P.INSURANCE_DETAILS " +
                                  "FROM HOSPITAL.CUSTOMER_SUPPORT CS " +
                                  "INNER JOIN HOSPITAL.PATIENT P ON CS.PATIENT_ID = P.PATIENT_ID";
